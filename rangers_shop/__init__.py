...
app = Flask(__name__) #is passing th ename of our directory as the name of our app
...
cors = CORS(app) #cross origin resource sharing aka allwoing othe rapps to talk to our API
